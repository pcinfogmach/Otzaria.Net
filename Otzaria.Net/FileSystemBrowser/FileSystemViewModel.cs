...
namespace FileSystemBrowser
{
    public class FileSystemViewModel : ViewModelBase
    {
        ...
        public string RootDirectory { get => _rootDirectory; set { SetProperty(ref _rootDirectory, value); Initialize(value); } }
        ...
        async void Initialize(string root)
        {
            ...
            var htmlItems = _rootItem.Children.OfType<HtmlFileSystemItem>();
